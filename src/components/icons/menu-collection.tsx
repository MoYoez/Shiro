...
export function TrainToIcon(props: SVGProps<SVGSVGElement>) {
  return (
     <svg
      width="1em"
      height="1em"
      ...
      {...props}
    >
      <path d="M170,50.021h120c4.143,0,7.5-3.358,7.5-7.5s-3.357-7.5-7.5-7.5H170c-4.142,0-7.5,3.358-7.5,7.5S165.858,50.021,170,50.021z" />
      <path d="M115.513,256.753c-12.407,0-22.5,10.093-22.5,22.5s10.093,22.5,22.5,22.5s22.5-10.093,22.5-22.5S127.92,256.753,115.513,256.753z M115.513,286.753c-4.136,0-7.5-3.364-7.5-7.5s3.364-7.5,7.5-7.5s7.5,3.364,7.5,7.5S119.649,286.753,115.513,286.753z" />
      <path d="M354.488,256.753c-12.406,0-22.5,10.093-22.5,22.5s10.094,22.5,22.5,22.5s22.5-10.093,22.5-22.5S366.894,256.753,354.488,256.753z M354.488,286.753c-4.136,0-7.5-3.364-7.5-7.5s3.364-7.5,7.5-7.5s7.5,3.364,7.5,7.5S358.624,286.753,354.488,286.753z" />
